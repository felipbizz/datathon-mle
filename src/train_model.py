...
if 'target' in df.columns:
    ...
    raise ValueError('Coluna target não encontrada no dataset de features. Execute a etapa de definição do target.')
...
with open('../Datathon Decision/3_silver/modelo_treinado.pkl', 'wb') as f:
    pickle.dump({'model': best_model, 'imputer': imputer, 'scaler': scaler, 'features': features}, f)
