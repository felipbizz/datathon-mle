...
with DAG(
    dag_id='db_decision.tb_history_prospects',
    default_args=default_args,
    description='Responsável pelo trigger da db_decision.tb_history_prospects',
    ...
    start_glue_job = AwsGlueJobOperator(
        ...
        job_name='db_decision.tb_history_prospects',
